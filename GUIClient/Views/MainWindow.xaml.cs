...
namespace GUIClient.Views
{
    public class MainWindow : Window
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnConsumerGet = this.Find<Button>("btnConsumerGet");
            outputText = this.Find<TextBlock>("outputText");
        ...
        private async void BtnConsumerGet_Click(object sender, Avalonia.Interactivity.RoutedEventArgs e)
        {
            ...
            var hubConnection = new HubConnection(factory, new JsonHubProtocol(), null);
            ...
            methodsWithEncryption.ForEach(method =>
            {
                hubConnection.On<String>(method, (data) =>
                {
                    ...
                    Dispatcher.UIThread.InvokeAsync(() => outputText.Text = JToken.Parse(data).ToString(Formatting.Indented));
